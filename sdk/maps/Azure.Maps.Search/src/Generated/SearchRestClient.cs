...
namespace Azure.Maps.Search
{
    internal partial class SearchRestClient
    {
        ...
        public SearchRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null, string apiVersion = "2022-12-01-preview", string acceptLanguage = null, string clientId = null)
        {
        ...
        internal HttpMessage CreateGetGeocodingRequest(int? top, string query, string addressLine, IEnumerable<string> countryRegionSet, IEnumerable<double> bbox, string view, IEnumerable<double> location, string adminDistrict, string adminDistrict2, string adminDistrict3, string locality, string postalCode, StrictMatchEnum? strictMatch)
        {
            ...
            if (countryRegionSet != null && Optional.IsCollectionDefined(countryRegionSet))
            {
                uri.AppendQueryDelimited("countryRegionSet", countryRegionSet, ",", true);
            }
            if (bbox != null && Optional.IsCollectionDefined(bbox))
            {
            ...
            if (location != null && Optional.IsCollectionDefined(location))
            {
                uri.AppendQueryDelimited("location", location, ",", true);
            }
            ...
            if (strictMatch != null)
            {
                uri.AppendQuery("strictMatch", strictMatch.Value.ToString(), true);
            }
            request.Uri = uri;
        ...
        /// </param>
        /// <param name="location"> A point on the earth specified as a longitude and latitude. When you specify this parameter, the user’s location is taken into account and the results returned may be more relevant to the user. Example: &amp;location=lon,lat. </param>
        ...
        public async Task<Response<GeocodingResponse>> GetGeocodingAsync(int? top = null, string query = null, string addressLine = null, IEnumerable<string> countryRegionSet = null, IEnumerable<double> bbox = null, string view = null, IEnumerable<double> location = null, string adminDistrict = null, string adminDistrict2 = null, string adminDistrict3 = null, string locality = null, string postalCode = null, StrictMatchEnum? strictMatch = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateGetGeocodingRequest(top, query, addressLine, countryRegionSet, bbox, view, location, adminDistrict, adminDistrict2, adminDistrict3, locality, postalCode, strictMatch);
        ...
        /// </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<GeocodingResponse> GetGeocoding(int? top = null, string query = null, string addressLine = null, IEnumerable<string> countryRegionSet = null, IEnumerable<double> bbox = null, string view = null, IEnumerable<double> location = null, string adminDistrict = null, string adminDistrict2 = null, string adminDistrict3 = null, string locality = null, string postalCode = null, StrictMatchEnum? strictMatch = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateGetGeocodingRequest(top, query, addressLine, countryRegionSet, bbox, view, location, adminDistrict, adminDistrict2, adminDistrict3, locality, postalCode, strictMatch);
        ...
        internal HttpMessage CreateGetPolygonRequest(IEnumerable<double> coordinates, string view, BoundaryResultTypeEnum? resultType, ResolutionEnum? resolution)
        {
            ...
            uri.AppendQuery("api-version", _apiVersion, true);
            if (coordinates != null && Optional.IsCollectionDefined(coordinates))
            {
        ...
        internal HttpMessage CreateGetReverseGeocodingRequest(IEnumerable<double> coordinates, IEnumerable<ReverseGeocodingResultTypeEnum> resultTypes, string view)
        {
            ...
            if (resultTypes != null && Optional.IsCollectionDefined(resultTypes))
            {
