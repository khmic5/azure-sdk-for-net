...
namespace Azure.Maps.Search.Models
{
    ...
    public static partial class MapsSearchModelFactory
    {
        ...
        public static FeaturesItemProperties FeaturesItemProperties(string type = null, ConfidenceEnum? confidence = null, IEnumerable<MatchCodesEnum> matchCodes = null, MapsAddress address = null, IEnumerable<GeocodePointsItem> geocodePoints = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.MapsAddress"/>. </summary>
        ...
        public static MapsAddress MapsAddress(string addressLine = null, string locality = null, string neighborhood = null, IEnumerable<AddressAdminDistrictsItem> adminDistricts = null, string postalCode = null, AddressCountryRegion countryRegion = null, string formattedAddress = null, Intersection intersection = null)
        {
            adminDistricts ??= new List<AddressAdminDistrictsItem>();

            return new MapsAddress(addressLine, locality, neighborhood, adminDistricts?.ToList(), postalCode, countryRegion, formattedAddress, intersection);
        }
        ...
        public static GeoJsonObject GeoJsonObject(IEnumerable<double> bbox = null)
        {
            bbox ??= new List<double>();

            return new UnknownGeoJsonObject(default, bbox?.ToList());
        }
