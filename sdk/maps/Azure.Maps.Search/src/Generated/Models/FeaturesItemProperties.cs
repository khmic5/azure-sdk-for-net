...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class FeaturesItemProperties
    {
        ...
        internal FeaturesItemProperties(string type, ConfidenceEnum? confidence, IReadOnlyList<MatchCodesEnum> matchCodes, MapsAddress address, IReadOnlyList<GeocodePointsItem> geocodePoints)
        {
            Type = type;
