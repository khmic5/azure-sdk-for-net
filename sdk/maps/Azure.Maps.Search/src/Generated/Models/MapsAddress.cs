...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class MapsAddress
    {
        ...
        internal MapsAddress(string addressLine, string locality, string neighborhood, IReadOnlyList<AddressAdminDistrictsItem> adminDistricts, string postalCode, AddressCountryRegion countryRegion, string formattedAddress, Intersection intersection)
        {
